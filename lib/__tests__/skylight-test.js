...
describe('SkyLight', function () {
    ...
    it('Show a title in h2 tag', function () {
        ...
        var skylight = TestUtils.renderIntoDocument(React.createElement(SkyLight, { title: titleTest }));
    ...
    it('Show a content', function () {
        ...
        var skylight = TestUtils.renderIntoDocument(React.createElement(
            SkyLight,
            null,
            root
        ));
    ...
    it('Overlay cant be rendered if showOverlay is false', function () {
        var skylight = TestUtils.renderIntoDocument(React.createElement(SkyLight, { showOverlay: false }));
    ...
    it('Should be set display:block when isVisible it was changed to true', function () {
        ...
        var skylight = TestUtils.renderIntoDocument(React.createElement(SkyLight, null));

        var instance = TestUtils.findRenderedComponentWithType(skylight, React.createElement(SkyLight, null));
